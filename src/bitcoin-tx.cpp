...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " scholarship-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  scholarship-tx [options] <hex-tx> [commands]  Update hex-encoded scholarship transaction\n" +
            "or:     scholarship-tx [options] -create [commands]   Create hex-encoded scholarship transaction\n" +
            "\n";
