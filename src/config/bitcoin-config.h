...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Scholarship Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Scholarship Core"
...
#define PACKAGE_BUGREPORT "https://github.com/scholarshipcoin/scholarshipcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Scholarship Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Scholarship Core 0.19.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "scholarship"
