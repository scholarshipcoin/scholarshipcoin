    ...
    m_network_style(networkStyle)
{
    ...
    // See https://doc.qt.io/qt-5/gallery.html
        ...
        progressBar->setStyleSheet("QProgressBar { background-color: transparent; font-family: Diversa Sans Com Black, sans-recif; font-weight: normal; max-height: 12px; color: #141414; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #0A3451, stop: 1 #88D0FB); border-radius: 7px; margin: 0px; max-height: 12px;  }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Scholarship address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and scholarship: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Scholarship addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Scholarship addresses"));
    ...
    openAction->setStatusTip(tr("Open a scholarship: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Scholarship command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Scholarship network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Scholarship"); // default title
