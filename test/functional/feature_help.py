...
"""Verify that starting scholarshipcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start scholarshipcoin with -h for help text")
        ...
        self.log.info("Start scholarshipcoin with -version for version information")
