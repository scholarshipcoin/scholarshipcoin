...
"""Verify that starting scholarship with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start scholarship with -h for help text")
        ...
        self.log.info("Start scholarship with -version for version information")
        ...
        self.log.info("Start scholarshipd with -fakearg to make sure it does not start")
