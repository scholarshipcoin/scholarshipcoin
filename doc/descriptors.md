# Support for Output Descriptors in Scholarship Core

Since Scholarship Core v0.17, there is support for Output Descriptors. This is a
...
on Scholarship's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Scholarship Core wallets, a convenience function `combo` is
