Scholarship Core version 0.14.2 is now available from:
  ...
  <https://download.scholarshipcoin.org/scholarship-0.14.2.0/>
...
- http://testnet.scholarshiptools.com
...
Commands sent over the JSON-RPC interface and through the `scholarship-cli` binary
can now use named arguments. This follows the [JSON-RPC specification](http://www.jsonrpc.org/specification)
for passing parameters by-name with an object.

`scholarship-cli` has been updated to support this by parsing `name=value` arguments
when the `-named` option is given.

Some examples:

    src/scholarship-cli -named help command="help"
    src/scholarship-cli -named getblockhash height=0
    src/scholarship-cli -named getblock blockhash=000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f
    src/scholarship-cli -named sendtoaddress address="(snip)" amount="1.0" subtractfeefromamount=true
...
here, originally written for Bitcoin but can also be used for Scholarship:
