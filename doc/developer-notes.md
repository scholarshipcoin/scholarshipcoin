...
- [Development guidelines](#development-guidelines)
    - [General Scholarship Core](#general-scholarship-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
Scholarship Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
([`valgrind.supp`](https://github.com/scholarshipcoin/scholarshipcoin/blob/master/contrib/valgrind.supp))
...
To profile a running scholarshipd process for 60 seconds, you could use an
invocation of `perf record` like this:

```sh
$ perf record \
    -g --call-graph dwarf --per-thread -F 140 \
    -p `pgrep scholarshipd` -- sleep 60
```
