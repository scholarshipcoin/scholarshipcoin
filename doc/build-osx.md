...
Before running, you may create an empty configuration file:
    ...
    mkdir -p "/Users/${USER}/Library/Application Support/Scholarship"

    touch "/Users/${USER}/Library/Application Support/Scholarship/scholarship.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Scholarship/scholarship.conf"

The first time you run scholarshipd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
