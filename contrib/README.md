...
Contains files used to package scholarshipd/scholarship-qt
for Debian-based Linux systems. If you compile scholarshipd/scholarship-qt yourself, there are some useful files here.
...
### [RPM](/contrib/rpm) ###
RPM spec file for building bscholarship-core on RPM based distributions.
