...
bech32_templates = [
  ...
  ('scho',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('scho',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('scho',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tscho',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tscho',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tscho',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rscho',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rscho',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rscho', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tscho',  17, 32, False, False, False),
  ('rscho',  3,  1, False, False, False),
  ('scho',   15, 41, False, False, False),
  ('tscho',  0, 16, False, False, False),
  ('rscho',  0, 32, True,  False, False),
  ('scho',   0, 16, True,  False, False),
  ('tscho',  0, 32, False, True,  False),
  ('rscho',  0, 20, False, False, True)
]
